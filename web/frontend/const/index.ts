export const ESTAFETA_LINKS = {
  nuevoEnvio: () =>
    `https://pdv.estafeta.com/EstafetaPlugIn_UI/NewOrCreateShipment`,
  ...
  nuevaRecoleccion: () =>
    `https://pdv.estafeta.com/EstafetaPlugIn_UI/NewPickUp`,

  reprogramar: (code: string) =>
    `https://pdv.estafeta.com/EstafetaPlugIn_UI/NewPickUp?NoPickup=${code}`,
